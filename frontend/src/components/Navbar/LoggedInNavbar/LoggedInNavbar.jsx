...
const styles = {
  menu: { flex: 1, minWidth: 0, justifyContent: 'center', borderBottom: 'none',},
  dropdownArea: { display: 'flex', alignItems: 'center', cursor: 'pointer', padding: '0 12px' },
...
const LoggedInNavbar = ({ activeKey = '1' }) => {
    ...
    // Dummy user object, replace with actual user data
    const user = {
      name: "Sachit",
      avatarLetter: "S"
    };
    ...
    return(
        <div className="header" style={{ display: 'flex', alignItems: 'center', marginBottom: '16px' }}>
            {/* Project Name (Logo) */}
            ...
            >
                <div 
                    style={{ ...styles.dropdownArea, ...(isHovered ? styles.dropdownHover : {}) }}
