...
const features = [
  {
    icon: <Feather size={32} color="#fff" />,
    title: "Digitize Your Legacy",
    description:
      "Easily transcribe your grandmother’s handwritten recipes and keep them safe forever.",
    color: "#52c41a",
  },
  {
    ...
    description:
      "Find recipes instantly by ingredient, cuisine, or time—never eat the same thing twice.",
    color: "#faad14",
  },
  {
    icon: <Share2 size={32} color="#fff" />,
    title: "Share & Collaborate",
    description:
      "Invite family and friends to view, rate, and contribute to your shared cooknects.",
    color: "#1890ff",
  },
];
...
const testimonials = [
  {
    quote:
      "Cooknect saved my family traditions. Everything is organized, and the search function is flawless!",
    author: "Jamie Oliver, Home Chef",
    rating: 5,
  },
  {
    quote:
      "The best platform for food bloggers and home cooks. Sharing my new creations is easier than ever.",
    author: "Sonia P., Recipe Creator",
    rating: 5,
  },
  {
    quote:
      "Absolutely essential for anyone who loves cooking. No more messy papers or lost recipes!",
    author: "Alex K., Food Enthusiast",
    rating: 4,
  },
];
...
const metrics = [
  {
    count: "10K+",
    label: "Active Users",
    icon: <Users color="#1890ff" />,
    color: "#e6f7ff",
  },
  {
    count: "500K+",
    label: "Recipes Stored",
    icon: <Utensils color="#52c41a" />,
    color: "#f6ffed",
  },
  {
    count: "4.8/5",
    label: "Average Rating",
    icon: <Star fill="#faad14" color="#faad14" />,
    color: "#fffbe6",
  },
  {
    count: "1.2M",
    label: "Meals Cooked",
    icon: <Heart color="#ff4d4f" />,
    color: "#fff0f6",
  },
];
  ...
  return (
    ...
    >
      <img
        ...
        onError={(e) => {
          console.log("Error loading mobile.png:", e);
...
const text1 = (
  <p style={{ paddingInlineStart: 24, fontSize: "16px" }}>
    Learn how to upload your own recipes, add ingredient lists, cooking steps,
...
const text2 = (
  <p style={{ paddingInlineStart: 24, fontSize: "16px" }}>
    Our platform automatically calculates calories, macros, and nutritional
    insights to help you eat smarter.
  </p>
);

const text3 = (
  <p style={{ paddingInlineStart: 24, fontSize: "16px" }}>
    Join weekly cooking challenges, earn badges, and compete with other home
    chefs for fun rewards.
  </p>
);

const text4 = (
  <p style={{ paddingInlineStart: 24, fontSize: "16px" }}>
    Save your favorite recipes, create collections like “Meal Prep,” “Family
    Dinners,” or “5-Ingredient Meals,” and access them anytime.
  </p>
);

const text5 = (
  <p style={{ paddingInlineStart: 24, fontSize: "16px" }}>
    Tag ingredients, mark allergens, add dietary categories (Vegan, Keto,
    Gluten-Free), and help others find the recipes that fit their lifestyle.
  </p>
);
...
const items = [
  ...
  },
  {
    ...
    label: (
      <p style={{ fontSize: "14px", fontWeight: "800" }}>
        Saving Recipes & Creating Collections
      </p>
    ),
    children: text4,
  },
  {
    ...
    label: (
      <p style={{ fontSize: "14px", fontWeight: "800" }}>
        Ingredient Tagging & Dietary Labels
      </p>
    ),
    children: text5,
  },
      ...
      <Content>
        ...
        <div style={styles.heroSection(token)}>
          ...
          <Paragraph style={styles.heroSubtitle}>
            Organize, discover, and share your favorite culinary creations with
            the ultimate online cooknect.
          </Paragraph>
          <Button
            type="primary"
            size="large"
          ...
          >
            {metrics.map((metric, index) => (
              <Col xs={24} sm={12} lg={6} key={index}>
                <Card
                  hoverable
                  style={styles.metricCard(metric.color)}
        ...
        <div
          style={{ ...styles.section, backgroundColor: token.colorBgLayout }}
        >
          <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
            <Row gutter={[48, 48]} align="middle">
              ...
              <Col xs={24} md={12} style={{ textAlign: "left" }}>
                ...
                >
                  Forget messy binders. Cooknect's intuitive interface lets you
                  quickly input, edit, and categorize recipes, making them
        ...
        <div style={{ ...styles.section, backgroundColor: "#fff" }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <Title
              level={2}
              style={{ color: token.colorTextHeading, marginBottom: "40px" }}
            >
        ...
        <div
          style={{ ...styles.section, backgroundColor: token.colorPrimaryBg }}
        >
          <Title
            level={2}
            style={{ color: token.colorTextHeading, marginBottom: "40px" }}
        ...
        <div style={{ maxWidth: "1200px", margin: "40px auto" }}>
          <div style={styles.recipeOfTheDayBanner}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                A bright, simple 20-minute meal. Discover the community's
                highest-rated recipes, curated daily by our experts.
              </Paragraph>
              <Button
                type="primary"
                size="large"
        ...
        <div
          style={{
            ...
            borderTop: `5px solid ${token.colorError}`,
          }}
        >
          <Title
            level={2}
            style={{ color: token.colorError, marginBottom: "16px" }}
          >
